package com.bibitaries.sepakbola.data.local

import android.content.Context
import android.content.SharedPreferences
import com.bibitaries.sepakbola.data.model.ActionState
import com.bibitaries.sepakbola.data.model.AuthUser
import com.bibitaries.sepakbola.util.getObject
import com.bibitaries.sepakbola.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser> {
        ...
        return if (user == null) {
            ...
            ActionState(message = "Email atau password salah")
        }
    }
